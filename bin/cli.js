...
const BRAND = chalk.bold.magenta('SV Agency Designer');
...
program
  .command('init')
  .description('Bootstrap your project with SV Agency Designer rules and assets.')
...
program
  .command('audit')
  .description('Audit your project against the SV Premium Rubric.')
  .action(() => {
